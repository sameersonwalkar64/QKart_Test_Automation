...
public class QkartSanity {
    ...
    public static Boolean TestCase01(RemoteWebDriver driver)
        ...
        TakeScreenshot(driver, "testCase1_Start");
        ...
        logStatus("End TestCase", "Test Case 1: Verify user Registration : ",
                status ? "PASS" : "FAIL");
        TakeScreenshot(driver, "testCase_1_end");
    ...
    public static Boolean TestCase02(RemoteWebDriver driver)
        ...
        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
        TakeScreenshot(driver, "testCase2_Start");
        status = registration.registerUser("testUser", "abc@123", true);
        ...
        logStatus("End TestCase", "Test Case 2: Verify user Registration : ",
                status ? "FAIL" : "PASS");
        TakeScreenshot(driver, "testCase2_End");
        return !status;
    }
    ...
    public static Boolean TestCase03(RemoteWebDriver driver)
        ...
        TakeScreenshot(driver, "testCase3_Start");
        ...
        TakeScreenshot(driver, "testCase3_End");
        return true;
    }
    ...
    public static Boolean TestCase04(RemoteWebDriver driver)
        ...
        Home homePage = new Home(driver);
        homePage.navigateToHome();
        TakeScreenshot(driver, "testCase4_Start");
        ...
        TakeScreenshot(driver, "testCase4_End");
        return status;
    }
    ...
    public static Boolean TestCase05(RemoteWebDriver driver)
        ...
        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
        TakeScreenshot(driver, "testCase5_Start");
        // Register a new user
        status = registration.registerUser("testUser", "abc@123", true);
        Thread.sleep(8000);
        if (!status) {
        ...
        logStatus("End TestCase", "Test Case 5: Happy Flow Test Completed : ",
                status ? "PASS" : "FAIL");
        TakeScreenshot(driver, "testCase5_End");
        return status;
    }
    ...
    public static Boolean TestCase06(RemoteWebDriver driver)
        ...
        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
        TakeScreenshot(driver, "testCase6_Start");
        // Register a new user
        status = registration.registerUser("testUser", "abc@123", true);
        Thread.sleep(3000);
        if (!status) {
        ...
        logStatus("End TestCase", "Test Case 6: Verify that cart can be edited: ",
                status ? "PASS" : "FAIL");
        TakeScreenshot(driver, "testCase6_End");
        return status;
    }
    ...
    public static Boolean TestCase07(RemoteWebDriver driver)
        ...
        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
        TakeScreenshot(driver, "testCase7_Start");
        status = registration.registerUser("testUser", "abc@123", true);
        if (!status) {
        ...
        logStatus("End TestCase",
                "Test Case 7: Verify that insufficient balance error is thrown when the wallet balance is not enough: ",
                status ? "PASS" : "FAIL");
        TakeScreenshot(driver, "testCase7_End");
        return status;
    }

    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException, IOException {
        Boolean status = false;
        ...
        logStatus("Start TestCase",
                ...
                Register registration = new Register(driver);
                registration.navigateToRegisterPage();
                TakeScreenshot(driver, "testCase8_Start");
                status = registration.registerUser("testUser", "abc@123", true);
                if (!status) {
                    logStatus("Step Failure", "User Perform Registration Failed", status ? "PASS" : "FAIL");
                    logStatus("End TestCase",
        ...
        List<String> listOfWindow = new ArrayList<>(windowsSet);
        driver.switchTo().window(listOfWindow.get(1));
        homePage.navigateToHome();
        
        List<String> expectedProductTitle = Arrays.asList("YONEX Smash Badminton Racquet");
        status = homePage.verifyCartContents(expectedProductTitle);
        driver.close();
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
        Boolean status = false;
        logStatus("Start TestCase", "Test Case 9: Verify Privacy Policy & Terms of Service", "DONE");
        Home homePage = new Home(driver);
        homePage.navigateToHome();
        ...
        logStatus("Step Pass", "Verify that the url of the current tab does not change", status ? "PASS" : "FAIL");
        ...
        WebElement privaryPolicyHeader = driver.findElement(By.xpath("//h2[text()='Privacy Policy']"));
        status = privaryPolicyHeader.isDisplayed();
        logStatus("Step Pass", "Check if the privacy policy content is available on the newly opened tab", status ? "PASS" : "FAIL");
        
        WebElement termsService = driver.findElement(By.xpath("//a[text()='Terms of Service']"));
        termsService.click();
        ...
        List<String> newlistOfWindow = new ArrayList<>(newwindowsSet);
        driver.switchTo().window(newlistOfWindow.get(2));

        WebElement termsServiceText = driver.findElement(By.xpath("//h2[text()='Terms of Service']"));
        status = termsServiceText.isDisplayed();
        logStatus("Step Pass", "Check if the about us content is displayed on the newly opened tab", status ? "PASS" : "FAIL");

        driver.close();
        driver.switchTo().window(newlistOfWindow.get(1));
        driver.close();
        driver.switchTo().window(newlistOfWindow.get(0));
    ...
    public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
        ...
        Boolean status = false;
        // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
        logStatus("Start TestCase", "Test Case 10: Verify Contact Now Button is not Displayed", "DONE");
        Home homePage = new Home(driver);
        homePage.navigateToHome();
        ...
        // wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='Contact us']")));
        wait.until(ExpectedConditions.invisibilityOf(contactNowElement));
        status = contactUsElement.isDisplayed();  
            
            logStatus("TestCase 10",
                    "Test Case Pass. Switch to Switch to alert and verify Contact now button is not displayed", "PASS");
            logStatus("End TestCase", "Test Case 10: Verify verify Contact now button is not displayed : ", "PASS");

        return status;
    }

    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException, IOException {
        Boolean status = false;
        // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
        ...
        status = login.PerformLogin(lastGeneratedUserName, "abc@123");
        if (!status) {
            logStatus("Step Pass", "User Perform Login Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase", "Test Case 5: Happy Flow Test Failed : ",
                    status ? "PASS" : "FAIL");
        }
        ...
        List<WebElement> adElement = driver.findElements(By.xpath("//iframe"));
        status = adElement.size() == 3;
        logStatus("Step Pass", "Ensure that a total of 3 advertisements are present", status ? "PASS" : "FAIL");
        ...
        for(int i=0; i<=1; i++)  {
            ...
            status = url.endsWith("/checkout");
            logStatus("Step Pass", "Ensure that the buttons on the 2 QKART product advertisements are clickable", status ? "PASS" : "FAIL");
            driver.navigate().back();
            driver.switchTo().parentFrame();
        }
            logStatus("End TestCase", "Test Case 11: Verify verify Contact now button is not displayed : ", "PASS");
        return status;
    }

    public static void TakeScreenshot(WebDriver driver, String testCaseNo) throws IOException {
        String timeStamp = String.valueOf(java.time.LocalDateTime.now());
        // String fileName = String.format("ScreenShot_%s_%s.png", testCaseNo,timeStamp);
        TakesScreenshot takeScreenShot = (TakesScreenshot) driver;
        File src = takeScreenShot.getScreenshotAs(OutputType.FILE);
        File loc = new File("screenshots/" + testCaseNo + "_" + timeStamp + ".png");
