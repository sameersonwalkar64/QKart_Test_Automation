...
public class Home {
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            WebElement cartParent = driver.findElement(By.className("cart"));
            List<WebElement> cartContents = cartParent.findElements(By.xpath(".//div[@class='MuiBox-root css-0']/div"));

            ArrayList<String> actualCartContents = new ArrayList<String>() {
            };
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(cartItem.findElement(By.xpath("//div[@class='MuiBox-root css-0']/div/descendant::div[2]/div[1]")).getText().split("\n")[0]);
            }
